...
// PASTLWTR : 1.2
// File generated on 18/05/2009 20:52:30 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Program Files\Common Files\System\ado\msado21.tlb (1)
// LIBID: {00000201-0000-0010-8000-00AA006D2EA4}
// LCID: 0
// Helpfile: C:\WINDOWS\HELP\ado210.chm
...
const
  CServerData: TServerData = (
    ...
    IntfIID:   '{00000555-0000-0010-8000-00AA006D2EA4}';
...
procedure TRecordset.Set_Index(const pbstrIndex: WideString);
...
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.Index := pbstrIndex;
end;

function TRecordset.Get_Index: WideString;
begin
    Result := DefaultInterface.Index;
end;

procedure TRecordset.Seek(KeyValues: OleVariant; SeekOption: SeekEnum);
begin
  DefaultInterface.Seek(KeyValues, SeekOption);
end;
...
procedure TRecordsetProperties.Set_Index(const pbstrIndex: WideString);
  { Warning: The property Index has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TRecordsetProperties.Get_Index: WideString;
begin
    Result := DefaultInterface.Index;
end;
