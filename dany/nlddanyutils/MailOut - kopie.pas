...
uses
  Classes, IdSMTP, IdAttachmentFile;
...
uses
  SysUtils, IdMessage, SMTPSetup, RcsStrings;
...
begin
  ...
  try
    ...
    if trim(SMTPPort) = '' then SMTPPort := '25';
      ...
      begin
        ...
        begin
          if FileExists(Attachments[I]) then
            TIdAttachmentFile.Create(Mess.MessageParts, Attachments[I]);
        end;
      end;
